...
import com.anantheswar.adoremusique.adapters.PlaylistAdapter;
import com.anantheswar.adoremusique.dataloaders.PlaylistLoader;
import com.anantheswar.adoremusique.dialogs.CreatePlaylistDialog;
import com.anantheswar.adoremusique.models.Playlist;
import com.anantheswar.adoremusique.subfragments.PlaylistPagerFragment;
...
public class PlaylistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        MainActivity.mFirebaseAnalytics.logEvent("Playlist",params);
        return rootView;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (showAuto) {
            menu.findItem(R.id.action_view_auto_playlists).setTitle(R.string.hide_playlist);
        } else menu.findItem(R.id.action_view_auto_playlists).setTitle(R.string.show_playlist);
    }
