...
public final class PreferencesUtility {
    ...
    private static final String FIRST_UNLOCKED ="first_unlocked" ;
    private static final String SECOND_UNLOCKED ="second_unlocked" ;
    private static final String FIFTH_UNLOCKED = "fifth_unlocked";
    private static final String SIXTH_UNLOCKED = "sixth_unlocked";
    ...
    private static final String FIRST_UNLOCK_COUNT = "first_count" ;
    private static final String SECOND_UNLOCK_COUNT = "second_count" ;
    private static final String FIFTH_UNLOCK_COUNT = "fifth_count" ;
    private static final String SIXTH_UNLOCK_COUNT = "sixth_count" ;
    ...
    public boolean firstUnlocked() {
        return mPreferences.getBoolean(FIRST_UNLOCKED, false);
    }

    public static void setFirstUnlocked(final boolean b) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(FIRST_UNLOCKED, b);
        editor.apply();
    }

    public boolean secondUnlocked() {
        return mPreferences.getBoolean(SECOND_UNLOCKED, false);
    }

    public static void setSecondUnlocked(final boolean b) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(SECOND_UNLOCKED, b);
        editor.apply();
    }

    public boolean fifthUnlocked() {
        return mPreferences.getBoolean(FIFTH_UNLOCKED, false);
    }

    public static void setFifthUnlocked(final boolean b) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(FIFTH_UNLOCKED, b);
        editor.apply();
    }

    public boolean sixthUnlocked() {
        return mPreferences.getBoolean(SIXTH_UNLOCKED, false);
    }

    public static void setSixthUnlocked(final boolean b) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(SIXTH_UNLOCKED, b);
        editor.apply();
    }

    public static int firstUnlockCount() {
        return mPreferences.getInt(FIRST_UNLOCK_COUNT,3);
    }

    public static void setFirstUnlockCount(int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(FIRST_UNLOCK_COUNT, i);
        editor.apply();
    }

    public static int secondUnlockCount() {
        return mPreferences.getInt(SECOND_UNLOCK_COUNT,3);
    }

    public static void setSecondUnlockCount(int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(SECOND_UNLOCK_COUNT, i);
        editor.apply();
    }

    public static int fifthUnlockCount() {
        return mPreferences.getInt(FIFTH_UNLOCK_COUNT,3);
    }

    public static void setFifthUnlockCount(int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(FIFTH_UNLOCK_COUNT, i);
        editor.apply();
    }

    public static int sixthUnlockCount() {
        return mPreferences.getInt(SIXTH_UNLOCK_COUNT,3);
    }

    public static void setSixthUnlockCount(int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(SIXTH_UNLOCK_COUNT, i);
        editor.apply();
    }
    ...
    public static String getImagePath() {
        return mPreferences.getString(IMAGE_PATH, "");
    }
}
